...
//			shuttleSphere.fillProperty().set(Color.BLACK);
	...
	private void initiateSpheres() {
		...
		planetSpheres[10] = new Sphere(planets[10].getRadius()/300);
...
//		shuttleSphere.fillProperty().set(Color.RED);
	...
	private void initiatePlanets() {
		...
		Vector titanVelocityDayMinus3 = new Vector(7.388667142618575, 7.165479288815751, -2.801764418486511).multiply(10000);      		 // on day 1
		Vector titanVelocityDayMinus2 = new Vector(5.380111990587597, 6.313161831930436,-2.160334569570196E+00).multiply(10000);   		 // on day 2
		Vector titanVelocityDayMinus1 = new Vector(3.978232380137137, 4.831893989991773,-1.255068188650872).multiply(10000);        		// on day 3
		Vector titanVelocityActualDay = new Vector(3.371707374482320,2.994793746329275,2.454976700466006E-01).multiply(10000);      		// on day 4  --- actual day
		Vector titanVelocityDayPlus1 = new Vector(3.601977862482338E+00, 1.099903767607084E+00, 7.106404252646215E-01).multiply(10000);	 // on day 5

		Vector titanAccelerationDayMinus3 = new Vector((titanVelocityDayMinus2.getX()-titanVelocityDayMinus3.getX())/86400, (titanVelocityDayMinus2.getY()-titanVelocityDayMinus3.getY())/86400,(titanVelocityDayMinus2.getZ()-titanVelocityDayMinus3.getZ())/86400); // d1
		Vector titanAccelerationDayMinus2 = new Vector((titanVelocityDayMinus1.getX()-titanVelocityDayMinus2.getX())/86400, (titanVelocityDayMinus1.getY()-titanVelocityDayMinus2.getY())/86400,(titanVelocityDayMinus1.getZ()-titanVelocityDayMinus2.getZ())/86400); //d2
		Vector titanAccelerationMinus1 = new Vector((titanVelocityActualDay.getX()-titanVelocityDayMinus1.getX())/86400, (titanVelocityActualDay.getY()-titanVelocityDayMinus1.getY())/86400,(titanVelocityActualDay.getZ()-titanVelocityDayMinus1.getZ())/86400);	// d3
		Vector titanAccelerationActualDay = new Vector(( titanVelocityDayPlus1.getX()-titanVelocityActualDay.getX())/86400, ( titanVelocityDayPlus1.getY()-titanVelocityActualDay.getY())/86400,( titanVelocityDayPlus1.getZ()-titanVelocityActualDay.getZ())/86400); //d4

		Vector titanPositionActualDay = new Vector(3.500605637366027E+08,-1.460893515782361E+09, 1.092122830810875E+07); // day 4 --- actual day
		Vector titanPositionDayPlus1 = new Vector(3.503559548196704E+08, -1.460717245370000E+09, 1.094222627446115E+07); // Day 5

        //                                      velocity1                                                                      velocity2 																					velocity3																						velocity4
		// planets[10].setNextDataFirst(new Vector(7.388667142618575, 7.165479288815751, -2.801764418486511),   new Vector(5.380111990587597, 6.313161831930436,-2.160334569570196E+00),  new Vector(3.978232380137137, 4.831893989991773,-1.255068188650872), new Vector(3.371707374482320,2.994793746329275,2.454976700466006E-01), new Vector(3.500605637366027E+08, -1.460893515782361E+09, 1.092122830810875E+07));
		// planets[10].setNextDataFirst(titanVelocityDayMinus2,titanVelocityDayMinus1,titanVelocityActualDay,  titanVelocityDayPlus1, titanAcceleration1,titanAcceleration2,titanAcceleration3,titanAcceleration4, titanPosition5);
