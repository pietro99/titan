...
%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	This report is meant for everyone who would like to know more about a complete, safe space trip and its simulation. It is rather an introduction to this topic and it?s digital implementation. \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section{Travel}	%TODO more details on launch
	\subsection{Launch}
	...
	%TODO TO titan:PID and initial conditions
	\subsubsection{To Earth}
	%TODO  To earth: trajectory
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	%TODO why opendloop and not feedback
	\subsection{On Earth}
	%TODO no safe landing on earth
%%%%%%%%%%%%%%%%%%%%%%%%%%%		
