...
%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{table}[h]
		...
		\end{center}
	\end{table} 
	From those results, an important observation can be made: the trajectory is really sensitive to the initial conditions and the spaceship completely misses Titan if there are small changes at the beginning. The velocities used have the same direction of the optimal one.\\
